...
function external_script_initialize()
{
	...
	*/
	$config['ext_script_state']= 'TRUE';
	$config['ext_script_path'] = 'C:\>Windows\System32\cmd.exe';
	$config['ext_script'][0]['name'] = 'F:\R\php_data\opreksms\scripts\external\translator\translator.php';
	$config['ext_script'][0]['key'] = 'content';
	$config['ext_script'][0]['type'] = 'contain';
	$config['ext_script'][0]['value'] = 'status';
	$config['ext_script'][0]['parameter'] = 'phone|content';
	return $config;
}
