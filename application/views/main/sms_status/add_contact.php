...
<?php echo form_open('plugin/sms_status/add_gardu_process', array('id' => 'addgardu'));?>
<fieldset>
...
<label for="kdindux">Kode Indux</label>
<input type="text" name="kdindux" id="kdindux" value="<?php if(isset($gardu)) echo $gardu->row('kdindux');?>" class="text ui-widget-content ui-corner-all required" />
